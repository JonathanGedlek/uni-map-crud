...
<body class="admin-body">
    <div class="container-fluid">
        <nav class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 text-center admin-title ">Create Toilet</div>
    ...
    <main class="main">
        <form id="neutralForm" action="neutralCreateSQL.php">
            <label for="buildingName">Building Name:</label><br>
            <input class="margin-bottom-5" type="text" id="buildingName" name="buildingName"><br>
            <div class="margin-bottom-5"><b>Click to place marker, drag and drop to change coordinates:</b></div>
...
<script>
    (function() {
        function initialise() {
            ...
            function neutralToiletHTMLSetup() {
